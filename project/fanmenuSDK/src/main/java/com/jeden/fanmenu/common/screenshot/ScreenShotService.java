...
public class ScreenShotService extends Service {
    ...
    public void getScreenShot() {
        try {
            ...
            FanLog.v("ScreenShotService", "getScreenShot bitmap:" + screenBitmap);
    ...
    public class SaveTask extends AsyncTask<Image, Void, Bitmap> {
        ...
        protected void onPostExecute(Bitmap bitmap) {
            ...
            //预览图片
            if (bitmap != null) {
                new PreViewPicture(ScreenShotService.this).takeScreenshot(bitmap, true, true);
            }
        }
    }
    ...
    class PreViewPicture {
        ...
        void takeScreenshot(Bitmap bitmap, boolean statusBarVisible, boolean navBarVisible) {
            // Take the screenshot
            ...
            startAnimation(mScreenWidth, mScreenHeight,
