...
public class MyCustomCenterView extends CommonPositionView {
    ...
    private void initView(Context context){
        ...
        int textColor = rs.getColor(R.color.fanmenu_center_text_color);
        mBgColorStart = rs.getColor(R.color.fanmenu_center_bg_color_start);
        mBgColorEnd = rs.getColor(R.color.fanmenu_center_bg_color_end);
        int textWidth = FanMenuViewTools.dip2px(context, CENTER_TEXT_WIDTH);
        mViewWidth = rs.getDimensionPixelSize(R.dimen.fanmenu_center_view_width);
        mTextOffset = rs.getDimensionPixelSize(R.dimen.fanmenu_center_text_offset_x);
        mTextSize = rs.getDimensionPixelSize(R.dimen.fanmenu_center_text_width_half);
