...
public class MyCustomMenuDialog extends RelativeLayout implements View.OnClickListener{

    private static final String TAG = MyCustomMenuDialog.class.getSimpleName();
    ...
    public MyCustomMenuDialog(Context context) {
        super(context);
    }

    public MyCustomMenuDialog(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public MyCustomMenuDialog(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void initView(int dialogtype, DialogSubmitListener listener)
    {
        ...
        if(dialogtype == SelectCardState.CARD_STATE_TOOLBOX)
        {
            mToolboxModel = true;
            mTitle.setText(rs.getString(R.string.fanmenu_dialog_toolbox_title));
        ...
        {
            mToolboxModel = false;
            mTitle.setText(rs.getString(R.string.fanmenu_dialog_favorite_title));
    ...
    class GridViewAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            MyCustomMenuDialogItemView item;
            if (view == null) {
                item = (MyCustomMenuDialogItemView) mInflater.inflate(R.layout.my_custom_dialog_item_layout, null);
                item.setToolboxModel(mToolboxModel);
            } else {
                item = (MyCustomMenuDialogItemView) view;
            }
            ...
            item.setSelectChangeListener(new MyCustomMenuDialogItemView.DialogItemSelectChange() {
                @Override
    ...
    public void closeDialog()
    {
        ...
        va.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                MyCustomMenuManager.closeDialog(getContext());
            }
