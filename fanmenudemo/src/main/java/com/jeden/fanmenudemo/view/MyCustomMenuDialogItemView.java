...
public class MyCustomMenuDialogItemView extends RelativeLayout implements View.OnClickListener{
    ...
    public MyCustomMenuDialogItemView(Context context) {
        super(context);
    }

    public MyCustomMenuDialogItemView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public MyCustomMenuDialogItemView(Context context, AttributeSet attrs, int defStyleAttr) {
