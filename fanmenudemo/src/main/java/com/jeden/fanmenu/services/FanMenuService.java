...
import com.jeden.fanmenu.common.model.DataBeans;
import com.jeden.fanmenu.common.model.FanMenuConfig;

public class FanMenuService extends Service {
    private static final String TAG = FanMenuService.class.getSimpleName();
    ...
    public void showFlowingView() {
        long start = System.currentTimeMillis();
        FanMenuManager.showFlowingView(getApplicationContext());
        Log.v(TAG, "showFlowingView cost" + (System.currentTimeMillis() - start));
    }

    public void removeFlowingView() {
        FanMenuManager.removeFlowingView(getApplicationContext());
    }
    ...
    public static void initFanMenuSDK(Context context) {
        Intent intent = new Intent(context, FanMenuService.class);
